...
docker tag gymemogame-backend:latest pasitkku/gymemo-backend:v2
docker tag gymemogame-backend:latest pasitkku/gymemo-backend:latest
docker tag gymemogame-frontend:latest pasitkku/gymemo-frontend:v2
docker tag gymemogame-frontend:latest pasitkku/gymemo-frontend:latest

docker push pasitkku/gymemo-backend:v2
docker push pasitkku/gymemo-backend:latest
docker push pasitkku/gymemo-frontend:v2
